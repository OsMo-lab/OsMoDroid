...
1. Update your copy of the scene file on [line 456](https://github.com/tangrams/zinc-style-more-labels/blob/gh-pages/zinc-style-more-labels.yaml#L456) to reference the API key you created in Step 3 in the **Sign up** section above. 
